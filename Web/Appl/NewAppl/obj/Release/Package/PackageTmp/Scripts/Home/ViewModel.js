                ...
                if (responseA[0]["status"].toLowerCase() === "completed") {
                    ...
                    for (var i = 0; i < self.currentData.length; i++) {
                        ...
                        $("#solidQuo").append(
                             ...
                             '       <a href="#test0' + (i + 1) + '" class="soliloquy-link" title="' + self.currentData[i]["recipeTitle"] + '">' +
                             ...
                             '                       <a class="soliloquy-fc-title-link" href="#" title="' + self.currentData[i]["recipeTitle"] + '">' + self.currentData[i]["recipeTitle"] + '</a>' +
                             '                   </h2>' +
                             '               </div>' +
                             '           </div>' +
                             '       </div>' +
                        ...
                        $("#recentPosts").append(
                            ...
                            '            <a href="#test0' + (i + 1) + '">' + self.currentData[i]["recipeTitle"] + ', ' + self.currentData[i]["dateLoaded"] + '</a>' +
                            '        </h2>' +
                            '    </header>' +
                            '    <p class="entry-meta">' +
                            '        <span class="heart-this-wrap">' +
                            '            <a href="#test0' + (i + 1) + '" class="heart-this">' +
                            '                <span>0</span>' +
                            '            </a>' +
                            '        </span>' +
                            ...
                            '        </span> -->                                                                                                                                                                                                           ' +
                            '    </p>' +
                            '    <a href="#test0' + (i + 1) + '" class="grid-image alignleft">' +
                            ...
                            '    </div>' +
                            '    <p>' +
                            '        <a class="more-link" href="#test0' + (i + 1) + '">Продължи статията...</a>' +
                            '    </p>' +
                            '</article>');
                    }
